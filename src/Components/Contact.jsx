      ...
      <div className="flex flex-col items-center w-full mx-auto px-4 mt-24 lg:mt-24 lg:w-4/5">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center w-full z-10">
          ...
          <form
            ...
            method="post"
            className="scale border border-current p-4 lg:p-4 rounded-lg mt-4 md:h-full flex flex-col w-full sm:w-5/6 lg:w-1/2"
          >
            {successMessage && (
            ...
            <input
              ...
              className="bg-gray-300 text-black py-2 px-3 lg:py-3 lg:px-4 rounded mb-3 lg:mb-4 w-full focus:outline-none"
              required
            />
            <input
              type="email"
