...
function Home() {
  ...
  return (
    <div className="relative bg-gradient-to-r from-slate-950 to-slate-800 w-full min-h-screen flex items-center justify-center px-4 md:px-8 py-16 md:py-20 z-10">
      ...
      <div className="z-10 max-w-4xl flex flex-col items-center mt-12 md:mt-20 text-center">
        <h2 className="drops text-3xl md:text-4xl lg:text-5xl text-white font-extrabold tracking-wider mb-8 md:mb-4">Hi, I'm Vikash</h2>
        <h1 className="rightMove text-4xl md:text-5xl lg:text-7xl text-white font-extrabold tracking-widest mb-10 md:mb-6">Web Developer</h1>
        <p className="textMove text-md md:text-lg lg:text-xl text-white font-light mb-16 md:mb-12">
